            ...
            <div className="max-w-screen-xl mx-auto px-4">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 text-lg">
                        Stay updated with the latest transport information and announcements
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredNotices.map((notice) => {
                        ...
                        return (
                            <div key={notice._id} className={`bg-white rounded-lg shadow-md border-l-4 ${priorityInfo.color}`}>
                                <div className="p-6">
                                    ...
                                    <span className={`inline-block px-3 py-1 rounded-full text-xs font-medium mb-4 ${categoryColor}`}>
                                        {notice.category}
                                    </span>
