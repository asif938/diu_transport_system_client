...
import profile1 from '../assets/download.jpg';
import profile2 from '../assets/download.png';
        ...
        <div className="container mx-auto">
          <Swiper slidesPerView={1} ref={sliderRef}>
            <SwiperSlide>
              <SingleTestimonial
                image={profile1}
                details="The DIU Transport System has made my daily commute so much easier. Buses are on time, safe, and well-maintained always."
                name="Full Name"
            ...
            <SwiperSlide>
              <SingleTestimonial
                image={profile2}
                details="Earlier, I faced difficulty catching buses on time. Now, with live tracking and clear schedules, commuting is hassle-free and reliable"
                name="Full Name"
                position="Nutrition and Food Engineering"
              />
            </SwiperSlide>
              ...
              <div className="prev-arrow cursor-pointer" onClick={handlePrev}>
                <button className="d flex h-[60px] w-[60px] items-center justify-center rounded-full border border-stroke bg-white text-dark transition-all hover:border-transparent hover:drop-shadow-testimonial dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:hover:drop-shadow-none">
                  <svg
                    ...
                    className="fill-current text-black border-2 rounded-full p-3"
                  >
                    <path
          ...
          <div className="w-full">
            <div>  
              ...
              <p className="mb-11 text-base font-normal italic leading-[1.81] text-body-color dark:text-dark-6 sm:text-[22px]">
                ...
                {/* dark:text-white */}
              <h4 className="mb-2 text-[22px] font-semibold leading-[27px] text-black ">
                {name}
              </h4>
